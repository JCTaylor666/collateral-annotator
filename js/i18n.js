...
(function () {
  ...
  const DICT = {
    en: {
      ...
      saveDoneConflictsFmt: 'Saved {n} — {c} frame(s) skipped: the folder has a newer file; open them to choose which version to keep.',
    ...
    zh: {
      ...
      saveDoneConflictsFmt: '已保存 {n} —— 跳过 {c} 帧:文件夹里有更新的文件,打开后选择保留哪个版本。',
