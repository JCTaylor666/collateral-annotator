...
(function () {
  ...
  const DICT = {
    en: {
      ...
      noteExternalBackedUp: '{id}: the note.json already in the folder had not been read into this session, so it was kept as note.unread-backup.json before your note replaced it.',
    ...
    zh: {
      ...
      noteExternalBackedUp: '{id}:文件夹里原有的 note.json 本次没能读进来,已在你的笔记覆盖它之前保留为 note.unread-backup.json。',
