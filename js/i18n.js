...
(function () {
  ...
  const DICT = {
    en: {
      ...
      conflictKeptDisk: 'Kept the folder version. This session\u2019s copy was backed up to annotation.unsaved-backup.json.',
    ...
    zh: {
      ...
      conflictKeptDisk: '已保留文件夹版本。本次会话的内容已备份到 annotation.unsaved-backup.json。',
